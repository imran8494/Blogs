                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="username"><?= ucwords($_SESSION['name']); ?></span>
                            <b class="caret"></b>
                        </a>
            ...
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li <?= $page == 'add_blog.php' ? 'class="active"' : '' ?>><a href="add_blog.php">Add Blogs</a></li>
                            <li <?= $page == 'manage_blog.php' ? 'class="active"' : '' ?>><a href="manage_blog.php">Manage Blogs</a></li>
                        </ul>
                    </li>
